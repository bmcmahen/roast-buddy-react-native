...
import { Base, Divider, Text, Icon, TouchableIcon } from "../components";
...
class Recorder extends React.Component {
        ...
        <Base height={45} alignItems="center" row flex={1}>
          <Base width={40} alignItems="center" justifyContent="center">
            {isLast && (
              ...
              >
                <Icon name="ios-close" color="#aaa" size={30} />
              </TouchableIcon>
            )}
          </Base>
          <Text light thin flex={1}>
            {labels[crack.key]}
          </Text>
          <Text mr={2} large thin style={{ fontFamily: "helvetica neue" }}>
  ...
  render() {
    ...
    let startLabel = isRecording ? "Stop" : "Start";
